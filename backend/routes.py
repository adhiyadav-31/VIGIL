...
Called by:
    - backend/main.py (mounted under the "/api" prefix)
"""
...
async def request_lease(payload: LeaseRequest):
    ...
    try:
        from backend.services.email_service import get_email_service, EmailConfigurationError
...
# ---------------------------------------------------------------------------
# Exception handler registration helper (wired in backend/main.py's app factory
...
# NOTE: backend/main.py should call `register_exception_handlers(app)` after
